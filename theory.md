...
Where, <br>
$n$ is the order of each minimum.<br>
$\lambda$ is the wavelength,<br>
$a$ is the distance between the slits<br>
$\theta$ is the angle at which destructive interference occurs. <br>
